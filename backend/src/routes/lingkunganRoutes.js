...
router.post('/', checkRole('admin', 'petugas'), imageUpload.single('foto'), lingkunganController.create);
router.put('/:id', checkRole('admin', 'petugas'), imageUpload.single('foto'), lingkunganController.update);
